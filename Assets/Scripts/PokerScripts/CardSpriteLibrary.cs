...
namespace UltimateTexasHoldEm
{
    ...
    ///  Your prefabs are now in Assets/Sprites/Asset_PlayingCards/Resources/Deck01/
    ///  so keep the default inspector folder value of "Deck01".
    ///
    ///  1. Ensure all Deck01 prefabs are in Assets/Sprites/Asset_PlayingCards/Resources/Deck01/
    ///
    ///  2. Optionally, leave the Resource Path as "Deck01" in this component.
    ///     The code also supports an empty path for top-level Resources/ if needed.
    ///
